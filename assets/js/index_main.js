...
// Get the modal
var text_mining_modal = document.getElementById('text_mining_modal');

// Get the button that opens the modal
var text_mining_btn = document.getElementById("text_mining_btn");

// Get the <a img> element that opens the modal
var text_mining_img = document.getElementById("text_mining_img");

// Get the <span> element that closes the modal
var text_mining_span = document.getElementsByClassName("text_mining_close")[0];

// When the user clicks the button, open the modal 
text_mining_btn.onclick = function() {
    text_mining_modal.style.display = "block";
}

// When the user clicks on <span> (x), close the modal
text_mining_span.onclick = function() {
    text_mining_modal.style.display = "none";
}

// When the user clicks the img, open the modal 
text_mining_img.onclick = function() {
    text_mining_modal.style.display = "block";
}
...
window.onclick = function(event) {
    if (event.target == text_mining_modal) {
        text_mining_modal.style.display = "none";
    }
}
